...
trait TableModel extends PostgresJdbcContext {
    implicit v@@
}
...
object MetricsDataService {
    case class MetricsRawQueries(quill: Quill.Postgres[Literal]) {
        ...
        // def totalPlayTime = quote((licensorUUID: UUID) => )
    }
}
